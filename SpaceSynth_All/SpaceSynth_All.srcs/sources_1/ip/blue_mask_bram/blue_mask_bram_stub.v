...
// Command     : write_verilog -force -mode synth_stub -rename_top blue_mask_bram -prefix
//               blue_mask_bram_ red_mask_bram_stub.v
...
module blue_mask_bram(clka, wea, addra, dina, clkb, addrb, doutb)
