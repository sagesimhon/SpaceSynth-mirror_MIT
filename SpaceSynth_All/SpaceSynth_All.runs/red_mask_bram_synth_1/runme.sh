...
HD_PWD='C:/Users/Praj/Documents/2020 Fall/6.111/SpaceSynth_All/SpaceSynth_All.runs/red_mask_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log red_mask_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source red_mask_bram.tcl
