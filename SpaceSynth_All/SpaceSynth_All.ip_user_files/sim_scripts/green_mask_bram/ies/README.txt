...
#
# Generated by export_simulation on Sat Nov 28 18:31:53 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './green_mask_bram.sh' script.

./green_mask_bram.sh -reset_run
...
./green_mask_bram.sh -noclean_files

For more information on the script, please type './green_mask_bram.sh -help'.
