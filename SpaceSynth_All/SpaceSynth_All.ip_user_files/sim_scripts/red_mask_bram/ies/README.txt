...
#
# Generated by export_simulation on Fri Nov 27 12:37:14 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './red_mask_bram.sh' script.

./red_mask_bram.sh -reset_run
...
./red_mask_bram.sh -noclean_files

For more information on the script, please type './red_mask_bram.sh -help'.
