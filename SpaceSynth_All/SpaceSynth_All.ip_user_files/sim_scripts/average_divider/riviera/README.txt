...
#
# Generated by export_simulation on Sat Nov 28 11:52:06 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './average_divider.sh' script.

./average_divider.sh -reset_run
...
./average_divider.sh -noclean_files

For more information on the script, please type './average_divider.sh -help'.
