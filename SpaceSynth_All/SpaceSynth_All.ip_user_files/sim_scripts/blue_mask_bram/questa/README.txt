...
#
# Generated by export_simulation on Fri Nov 27 12:39:14 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './blue_mask_bram.sh' script.

./blue_mask_bram.sh -reset_run
...
./blue_mask_bram.sh -noclean_files

For more information on the script, please type './blue_mask_bram.sh -help'.
